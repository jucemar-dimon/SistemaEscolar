<%-- 
    Document   : CadastroAlunoAlterar
    Created on : 27/10/2019, 10:16:34
        ...
        <div class="container">
            ...
            <div class="jumbotron p-3">
                <section>
                    <article>
                        <header>
                            <h5>Cadastro de alunos  <small class="text-muted">Alteração</small></h5>
                            <hr class="my-1 mb-3">
                        </header>
                        ...
                        <form name="formCadastro" action="ControleAluno" method="POST">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-11">
                                    ...
                                    <input class="form-control" type="text" name="txtNomeAluno" value="<%=aluno.nomeAluno%>" />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Avaliação 01</label>
                                    <input class="form-control" type="text" name="txtAvaliacao1" value="<%=aluno.avaliacao1%>" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Avaliação 02</label>
                                    <input  class="form-control" type="text" name="txtAvaliacao2" value="<%=aluno.avaliacao2%>" />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-12 d-flex flex-row justify-content-end">
                                    <input class="btn btn-danger" type="submit" value="Cancelar" name="btnOperacao" />  
                                    <input class="btn btn-primary ml-3" type="submit" value="Alterar" name="btnOperacao" />  
                                </div>
                            </div>
                        </form>
                    </article>
