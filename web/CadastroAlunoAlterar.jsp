...
<html>
    ...
    <body>
        ...
        <form name="formCadastro" action="ControleAluno" method="POST">
            ...
            <input type="text" name="txtNomeAluno" value="<%=aluno.nomeAluno%>" />

            <label>Avaliação 01</label>
            <input type="text" name="txtAvaliacao1" value="<%=aluno.avaliacao1%>" />

            <label>Avaliação 02</label>
            <input type="text" name="txtAvaliacao2" value="<%=aluno.avaliacao2%>" />
